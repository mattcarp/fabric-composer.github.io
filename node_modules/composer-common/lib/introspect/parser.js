module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c226 = "concept",
        peg$c227 = { type: "literal", value: "concept", description: "\"concept\"" },
        peg$c228 = ";",
        peg$c229 = { type: "literal", value: ";", description: "\";\"" },
        peg$c230 = "}",
        peg$c231 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c232 = function() { return { type: "ThisExpression" }; },
        peg$c233 = "(",
        ...
        peg$c238 = function(elision) {
              return {
                type:     "ArrayExpression",
                elements: optionalList(extractOptional(elision, 0))
              };
            },
        peg$c239 = function(elements) {
              return {
                type:     "ArrayExpression",
                elements: elements
              };
        ...
        peg$c242 = function(elements, elision) {
              return {
                type:     "ArrayExpression",
                elements: elements.concat(optionalList(extractOptional(elision, 0)))
              };
            },
        peg$c243 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c244 = function(first, elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c245 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c246 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c247 = function(id) { return [id]; },
        peg$c248 = function(callee, args) {
                  return { type: "NewExpression", callee: callee, arguments: args };
                },
        peg$c249 = function(first, property) {
                  return { property: property, computed: true };
                },
        peg$c250 = function(first, property) {
        ...
        peg$c254 = function(first, args) {
                  return { type: "CallExpression", arguments: args };
                },
        peg$c255 = function(first, property) {
                  return {
                    type:     "MemberExpression",
                    property: property,
                    computed: true
        ...
        peg$c256 = function(first, property) {
                  return {
                    type:     "MemberExpression",
                    property: property,
                    computed: false
        ...
        peg$c327 = function(left, operator, right) {
              return {
                type:     "AssignmentExpression",
                operator: operator,
                left:     left,
        ...
        peg$c355 = function(declarations) {
              return {
                type:         "VariableDeclaration",
                declarations: declarations
              };
            },
        peg$c356 = function(id, init) {
              return {
        ...
        peg$c357 = function() { return { type: "EmptyStatement" }; },
        ...
        peg$c360 = function(test, consequent) {
              return {
                type:       "IfStatement",
                test:       test,
                consequent: consequent,
        ...
        peg$c361 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test }; },
        peg$c362 = function(test, body) { return { type: "WhileStatement", test: test, body: body }; },
        peg$c363 = function(init, test, update, body) {
              return {
                type:   "ForStatement",
        ...
        peg$c364 = function(declarations, test, update, body) {
              return {
                type:   "ForStatement",
                init:   {
                  type:         "VariableDeclaration",
        ...
        peg$c365 = function(left, right, body) {
              return {
                type:  "ForInStatement",
                left:  left,
                right: right,
        ...
        peg$c366 = function(declarations, right, body) {
              return {
                type:  "ForInStatement",
                left:  {
                  type:         "VariableDeclaration",
        ...
        peg$c373 = function(object, body) { return { type: "WithStatement", object: object, body: body }; },
        peg$c374 = function(discriminant, cases) {
              return {
        ...
        peg$c387 = "identified by",
        peg$c388 = { type: "literal", value: "identified by", description: "\"identified by\"" },
        peg$c389 = function(idField) {
                return idField
            },
        peg$c390 = function(abstract, id, idField, classExtension, body) {
              return {
        ...
        peg$c391 = function(abstract, id, idField, classExtension, body) {
                  return {
        ...
        peg$c392 = function(ex) {
              return {
                type:   "ClassExtension",
                class:     ex
              };
            },
        peg$c393 = function(abstract, id, idField, classExtension, body) {
              return {
        ...
        peg$c394 = function(abstract, id, classExtension, body) {
                  return {
        ...
        peg$c395 = "optional",
        peg$c396 = { type: "literal", value: "optional", description: "\"optional\"" },
        peg$c397 = function() {
              return {
                type: "Optional"
              };
            },
        peg$c398 = function(def) {
              return def.value;
            },
        peg$c399 = function(def) {
              return def;
            },
        peg$c400 = function(decls) {
              return {
        ...
        peg$c401 = "o",
        peg$c402 = { type: "literal", value: "o", description: "\"o\"" },
        peg$c403 = "[]",
        peg$c404 = { type: "literal", value: "[]", description: "\"[]\"" },
        peg$c405 = function(propertyType, array, id, d, optional) {
            	return {
        ...
        peg$c406 = "Boolean",
        peg$c407 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c408 = function(array, id, d, optional) {
            	return {
            		type: "FieldDeclaration",
            		id: id,
        ...
        peg$c409 = "DateTime",
        peg$c410 = { type: "literal", value: "DateTime", description: "\"DateTime\"" },
        peg$c411 = function(array, id, d, optional) {
            	return {
            		type: "FieldDeclaration",
            		id: id,
        ...
        peg$c412 = "String",
        peg$c413 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c414 = function(array, id, d, regex, optional) {
            	return {
            		type: "FieldDeclaration",
            		id: id,
        ...
        peg$c415 = "Integer",
        peg$c416 = { type: "literal", value: "Integer", description: "\"Integer\"" },
        peg$c417 = "Long",
        peg$c418 = { type: "literal", value: "Long", description: "\"Long\"" },
        peg$c419 = "Double",
        peg$c420 = { type: "literal", value: "Double", description: "\"Double\"" },
        peg$c421 = "regex",
        peg$c422 = { type: "literal", value: "regex", description: "\"regex\"" },
        peg$c423 = function(regex) {
           	return regex
          },
        peg$c424 = "range",
        peg$c425 = { type: "literal", value: "range", description: "\"range\"" },
        peg$c426 = function(lower, upper) {
           	return {
            	lower: lower,
              upper: upper
            }
          },
        peg$c427 = function(propertyType, array, id, d, range, optional) {
            	return {
            		type: "FieldDeclaration",
            		id: id,
        ...
        peg$c429 = function(decls) {
              return {
                type: "EnumDeclarationBody",
                declarations: optionalList(decls)
              };
            },
        peg$c430 = function(id, optional) {
            	return {
        ...
        peg$c433 = function(propertyType, array, id, optional) {
            	return {
        ...
        peg$c435 = function(namespace) {
          	return namespace;
          },
        peg$c436 = function(ns) {
            	return ns;
          },
        peg$c437 = function(ns, imports, body) {
              return {
                type: "Program",
                namespace: ns,
    ...
    function peg$parseIdentifiedByField() {
      ...
      s0 = peg$currPos;
      if (input.substr(peg$currPos, 13) === peg$c387) {
        s1 = peg$c387;
        peg$currPos += 13;
      } else {
        s1 = peg$FAILED;
    ...
    function peg$parseNumberDefault() {
      var s0, s1, s2, s3, s4, s5, s6;
    ...
    function peg$parseFieldDeclarations() {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parseNumberFieldDeclaration();
        if (s0 === peg$FAILED) {
    ...
    function peg$parseNumericDomainValidator() {
      var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13;
    ...
    function peg$parseNumberFieldDeclaration() {
      var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14;
                  ...
                  if (s7 !== peg$FAILED) {
                    ...
                    if (s8 !== peg$FAILED) {
                      ...
                      if (s9 !== peg$FAILED) {
                        s10 = peg$parse__();
                        if (s10 !== peg$FAILED) {
                          s11 = peg$parseNumericDomainValidator();
                          if (s11 === peg$FAILED) {
                            s11 = null;
                          }
                          if (s11 !== peg$FAILED) {
                            ...
                            if (s12 !== peg$FAILED) {
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  peg$savedPos = s0;
                                  s1 = peg$c427(s3, s5, s7, s9, s11, s13);
                                  s0 = s1;
                                } else {
                                  peg$currPos = s0;
                                  s0 = peg$FAILED;
